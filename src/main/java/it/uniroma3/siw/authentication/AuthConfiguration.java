...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/", "/index", "/login", "/register", "/birra", "/birra/**", "/birre", "/css", "/css/**","/img", "/img/**", "/fragments/**", "/cameriere/**", "/cameriere", "/fonts/**", "/js/**").permitAll()
                // chiunque (autenticato o no) può mandare richieste POST al punto di accesso per login e register 
                .antMatchers(HttpMethod.POST, "/login", "/register", "/cameriere/**" , "/cameriere").permitAll()
